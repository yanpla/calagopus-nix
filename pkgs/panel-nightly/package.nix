{
  ...
  version = "6030eb1abf97706c6db00489a3ae5730b0dea364";
  src = fetchFromGitHub {
    owner = "calagopus";
    repo = "panel";
    rev = "${version}";
    sha256 = "sha256-IGM3siU4c9swZAD+IvSOXRzdQ0dDh+aOjKsoermIgLE=";
  };
  frontend = stdenv.mkDerivation (finalAttrs: {
    ...
    pnpmDeps = fetchPnpmDeps {
      ...
      fetcherVersion = 3;
      hash = "sha256-3enfNgLFJQw74JDZaw4GKYW2u4F8amVfkzH1f30/SHg=";
    };
...
in
  rustPlatform.buildRustPackage (finalAttrs: {
    ...
    cargoHash = "sha256-plw/I8WcS2ompk34F2igPjR8kZd4COtYCe+1VvMC8J4=";
