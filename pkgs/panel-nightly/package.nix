{
  ...
  version = "88386e498ab7eed69baaeb1b03e5f6bbef409ce8";
  src = fetchFromGitHub {
    owner = "calagopus";
    repo = "panel";
    rev = "${version}";
    sha256 = "sha256-nzRFs9zSSEpFlwW0k1dCyW3/XfdPq+WKf23FQbj6RpQ=";
  };
  frontend = stdenv.mkDerivation (finalAttrs: {
    ...
    pnpmDeps = fetchPnpmDeps {
      ...
      fetcherVersion = 3;
      hash = "sha256-tRE4BTG4u8O1n25HJbnC4YFDrjTZTyO/7OWUC30P0ts=";
    };
...
in
  rustPlatform.buildRustPackage (finalAttrs: {
    ...
    cargoHash = "sha256-XRckYq35ZflAGyZ6aYYCdUw/np0fleVmw4ZUEYcFEko=";
